                ...
                <div class="w-full max-w-sm">
                    <a href="{{ route('auth.google') }}"
                        class="flex items-center justify-center gap-3 w-full py-3 px-6
                         border border-zinc-200 bg-white hover:bg-zinc-50 hover:border-zinc-300 transition-all
                         text-lg font-semibold text-zinc-800 shadow-sm cursor-pointer mb-3">
