    ...
    <div class="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <p class="leading-normal text-xl text-white/90 mb-8">
                Escribe un tema, elige tu idioma y FlashLearn genera 10 tarjetas de vocabulario personalizadas listas para estudiar. Así de fácil.
            </p>
            <div class="flex flex-col sm:flex-row gap-3 mx-auto lg:mx-0">
                <button class="cursor-pointer bg-white text-gray-800 font-bold rounded-full py-4 px-8 shadow-lg transform transition hover:scale-105 duration-300 ease-in-out">
                    Generar mis flashcards
                </button>
                <button class="cursor-pointer border-2 border-white/60 text-white font-semibold rounded-full py-4 px-8 hover:bg-white/10 transition duration-300">
                    Ver cómo funciona
                </button>
            </div>

            {{-- Social proof --}}
            <p class="mt-6 text-sm text-white/60 mx-auto lg:mx-0">
                Inglés, Francés, Alemán, Japonés y más idiomas disponibles
            </p>
        </div>
...
<div class="relative -mt-8 lg:-mt-40 overflow-hidden">
    <svg viewBox="0 0 1428 174" xmlns="http://www.w3.org/2000/svg">
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <g transform="translate(-4.000000, 76.000000)" fill="#fafafa" fill-rule="nonzero">
